...
/// @notice `FIAT` is the protocol's stable asset which can be redeemed for `Credit` via `Minter`
contract FIAT is AccessControl, ERC20Permit, IFIAT {

    /*//////////////////////////////////////////////////////////////
                             INITIALIZATION
    //////////////////////////////////////////////////////////////*/

    constructor() ERC20("Fixed Income Asset Token", "FIAT") ERC20Permit("Fixed Income Asset Token") {
