...
contract PositionActionYVTest is IntegrationTestBase {
    ...
    function test_borrow_yvDAI_vault_with_exit_swap_to_USDC() public {
        ...
        uint256 borrowAmount = 5_000 * 1e18; // borrow 5k fiat
    ...
    function test_repay() public {
        ...
        uint256 borrowAmount = 500*1e18; // fiat
    ...
    function test_depositAndBorrow_with_entry_and_exit_swap() public {
        ...
        uint256 borrowAmount = 5_000*1e18; // in fiat
    ...
    // withdraw dai and swap to usdc, then repay dai vault debt by swapping to fiat from usdc
