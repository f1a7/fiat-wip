...
contract TestBase is Test {
    ...
    uint256 internal constant initialGlobalDebtCeiling = 100_000_000 ether;
    ...
    function createCredit(address to, uint256 amount) internal {
        CreditCreator creditCreator = new CreditCreator(cdm);
    ...
    function _getDefaultVaultParams() internal view returns (CDPVaultParams memory) {
        return CDPVaultParams({
            cdm: cdm,
            oracle: oracle,
            buffer: buffer,
            token: token,
    ...
    function _getDefaultVaultParams_TypeA() internal pure returns (CDPVaultParams_TypeA memory) {
        return CDPVaultParams_TypeA({
    ...
    function _getDefaultVaultConfigs() internal view returns (CDPVaultConfigs memory) {
        return CDPVaultConfigs({
            debtFloor: 0,
            limitOrderFloor: WAD,
